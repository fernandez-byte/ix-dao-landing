...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:rgba(255,255,255,.82);' +
    ...
    '.empty .sub u{text-underline-offset:2px;text-decoration-color:rgba(255,255,255,.4)}' +
    '.empty:hover .sub u{color:rgba(255,255,255,.95);text-decoration-color:currentColor}' +
